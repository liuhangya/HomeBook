package com.fanda.homebook.ui.theme
...
val onSecondaryLight = Color(0xFF333333)    // 自定义了颜色，用于顶部标题的右边文本
...
val backgroundLight = Color(0xFFE3EBF5)     // 自定义了颜色，用于全局页面背景
val onBackgroundLight = Color(0xFF171D1A)
val surfaceLight = Color(0x99FFFFFF)          // 自定义了颜色，用于底部导航栏的背景
