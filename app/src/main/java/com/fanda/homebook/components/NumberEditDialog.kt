...
@Composable fun NumberEditDialog(
    title: String, modifier: Modifier = Modifier, placeholder: String = "请输入", value: String, onDismissRequest: () -> Unit, onConfirm: (String) -> Unit, maxChar: Int = 4, showSuffix: Boolean = false
) {
